...
export default function AddTransactionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700 transform transition-all duration-200 scale-100 opacity-100">
        {/* Header */}
        ...
        {/* Content */}
        <form id="transaction-form" onSubmit={handleSubmit} className="p-6 space-y-4">
          {error && (
